  ...
  return (
    <>
      <div className="absolute  text-center  text-black w-[100%] bottom-4">
        ...
        <small className="text-slate-300 text-sm">page -{number}</small>
      </div>
    </>
  );
};
    ...
    <>
      <div className="text-center  text-black w-[100%] mt-4">
        <div className="flex-col relative justify-center  p-2">
          <p className="text-[20px]">We'll meet again my brother</p>
          <hr className="w-full" />
...
const BoDy = (props) => {
  ...
  return (
    <>
      <div className="flex flex-wrap overflow-auto justify-center max-h-[70%] w-[100%] p-2  mt-4">
...
const Page = (props) => {
    ...
    return (
      <>
        <div className={`bg-[#fff]  w-[100%] h-[100%] relative`} style={style}>
          <Header />
...
export const Book = () => {
  return (
    <>
      <div className="flex lg:h-screen pb-40 justify-center  bg-[#c0cfe5]  w-screen overflow-y-auto ">
        ...
        <div class="text-center lg:mt-10 md:mt-16  sm:mt-4 xs:mt-[29%]  text-3xl w-screen ">
          <div className="flex flex-col justify-center items-center h-fit relative">
            <div className="bg-indigo-400 p-4 rounded-lg  flex justify-center w-[75vw] h-[80vh] relative">
              ...
              <div className="bg-[#eae8e8] flex justify-center  w-[100%]">
                <span className="absolute bottom-1/2 -left-16 bg-gray-light h-16 w-16 flex justify-center items-center rounded-full">
                  <IoIosArrowBack className="" />
                </span>
                <span className="absolute bottom-1/2 -right-16 bg-gray-light h-16 w-16 flex justify-center items-center rounded-full">
                  <IoIosArrowBack className="rotate-180   " />
                </span>
                <div className="w-[100%] h-[100%] shadow-2xl relative p-2 flex">
                  {FakeData.map((Contributor) => {
                    return (
                      <>
                        <Page data={Contributor} />
                      </>
                    );
                  })}
                </div>
