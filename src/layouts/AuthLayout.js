...
const AuthLayout = ({ children }) => {
  return (
    ...
    <div className="h-screen w-screen bg-white flex">
      ...
      <section className="h-[100%] bg-theme lg:flex md:hidden sm:hidden xs:hidden   w-[70%] flex items-center relative">
        <div className="h-[90vh]   flex  justify-center items-center w-[100%]">
          <section className="relative justify-center  lg:w-[90%] md:w-full sm:w-full p-14 xs:w-full lg:h-[96%]  bg-[#fdfdfd5c] opacity-100 rounded-3xl  md:h-1/2 sm:h-[60%] xs:h-[60%]" >
            ...
            <div className="absolute text-center p-2 -left-7 top-1/2 rounded-full w-[4rem] h-[4rem] bg-white text-black ">
              <FcCloseUpMode className='text-[3rem] ' />
            </div>
            ...
            <h1 className='Design font-bold Now mt-4 text-4xl text-center pb-3'> Design    With   <span className="text-6xl font-bold Now mt-2  text-center pb-3 text-blue-500">Sally </span> <RiHeart2Fill className='text-[5rem] inline-block text-red-600 -mt-5' />   </h1>
          </section>
        </div>
      </section>
